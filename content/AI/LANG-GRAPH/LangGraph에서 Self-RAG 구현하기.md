---
notion-id: 3cd737bad00c806babfffddf472e593d
created: 2026-08-31T19:20:00+09:00
---
## 1. Self-RAG 구현 (1) - 필요한 데이터 모델 정의하기

### 1.1. Retrieval Grader (질문 ↔ 문서)
...
### 1.3. Hallucination Grader (문서 ↔ 답변)
...
## 2. Self-RAG 구현 (2) - LangGraph로 그래프 구현
...
- `decide_to_generate_self` : 답변 생성 횟수 검증 함수
...
그래프 모형을 보면 문서 검색부터 답변 생성까지 스스로 판단하고 평가하면서 진행되는 [[Self-RAG]] 방식대로 잘 구현된 것을 볼 수 있다.