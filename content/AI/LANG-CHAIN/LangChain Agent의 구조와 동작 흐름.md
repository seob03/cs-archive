...
수동 체인의 경우에는 개발자가 직접 ToolCall 확인하고 이름 비교하고, Tool을 실행해야 한다. 또한 Tool을 실행한 결과를 가지고 두 번째 LLM을 다시 호출했다. ([Tool Calling](https://app.notion.com/p/Tool-Calling-3be737bad00c8068af0ae778b48c64b4?pvs=21) 참고)
